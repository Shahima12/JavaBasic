...
public class HW {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Based on the price you have to calculate the price of the item after
		the
		 * discount
		...
		if (sale.equalsIgnoreCase("no")) {
			...
			System.out.println("After " + discount + "% discount the price ofthe item reduce from " + actualPrice+ " to " + finalPrice);
		}
